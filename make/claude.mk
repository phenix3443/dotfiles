...
.PHONY: install-claude install-rtk install-gstack sync-claude apply-claude sync-codex apply-codex
...
help-claude:
	...
	@echo "  install-gstack      - 安装 gstack，并注册到 Claude Code 与 Codex"
...
install-gstack:
	@sh "$(SCRIPT_DIR)/install-gstack.sh"
