...
.PHONY: install help
.PHONY: install-chezmoi install-keepassxc-cli install-age install-lefthook install-gitleaks install-add-skill install-claude install-rtk install-zsh-plugins
...
install: install-chezmoi install-keepassxc-cli install-age install-lefthook install-gitleaks install-add-skill install-claude install-rtk install-zsh-plugins setup-hooks ensure-path bootstrap-chezmoi-config
