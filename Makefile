...
.PHONY: install help
.PHONY: install-chezmoi install-age install-lefthook install-gitleaks install-add-skill install-claude install-rtk install-gstack install-zsh-plugins
...
install: install-chezmoi install-age install-lefthook install-gitleaks install-add-skill install-claude install-rtk install-gstack install-zsh-plugins setup-hooks ensure-path bootstrap-chezmoi-config
